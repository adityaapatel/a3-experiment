...
To rank the three chosen visualization types from best to worst performance, we calculated and reported the average log2Error for each visualization across all trials and participants. We had 10 participants, with 20 trials per visualization type each. See this information in the table below and an example of each visualization type from our survey.
